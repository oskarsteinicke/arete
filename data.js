...
const BOOKS = [
  // Mind
  { title: 'Meditations', author: 'Marcus Aurelius', pillar: 'mind', desc: 'Timeless stoic wisdom on self-mastery and resilience from a Roman emperor.', url: 'https://www.goodreads.com/book/show/30659.Meditations' },
  { title: "Man's Search for Meaning", author: 'Viktor Frankl', pillar: 'mind', desc: 'How finding purpose sustains you through even the worst suffering.', url: 'https://www.goodreads.com/book/show/4069.Man_s_Search_for_Meaning' },
  { title: 'Thinking, Fast and Slow', author: 'Daniel Kahneman', pillar: 'mind', desc: 'Understand the two systems that drive how you think and decide.', url: 'https://www.goodreads.com/book/show/11468377-thinking-fast-and-slow' },
  { title: 'The Power of Now', author: 'Eckhart Tolle', pillar: 'mind', desc: 'A guide to spiritual enlightenment through present-moment awareness.', url: 'https://www.goodreads.com/book/show/6708.The_Power_of_Now' },
  { title: 'Atomic Habits', author: 'James Clear', pillar: 'mind', desc: 'Tiny changes, remarkable results \u2014 the definitive guide to building better habits.', url: 'https://www.goodreads.com/book/show/40121378-atomic-habits' },
  // Body
  { title: 'Starting Strength', author: 'Mark Rippetoe', pillar: 'body', desc: 'The bible of barbell training \u2014 learn the five fundamental lifts.', url: 'https://www.goodreads.com/book/show/2098.Starting_Strength' },
  { title: 'Why We Sleep', author: 'Matthew Walker', pillar: 'body', desc: 'The science of sleep and why it is the most important thing you can do for health.', url: 'https://www.goodreads.com/book/show/34466963-why-we-sleep' },
  { title: 'The Body Keeps the Score', author: 'Bessel van der Kolk', pillar: 'body', desc: 'How trauma reshapes the body and brain, and how to heal.', url: 'https://www.goodreads.com/book/show/18693771-the-body-keeps-the-score' },
  { title: 'Bigger Leaner Stronger', author: 'Michael Matthews', pillar: 'body', desc: 'Evidence-based approach to building muscle and losing fat.', url: 'https://www.goodreads.com/book/show/13367781-bigger-leaner-stronger' },
  // Mastery
  { title: 'Deep Work', author: 'Cal Newport', pillar: 'mastery', desc: 'Rules for focused success in a distracted world.', url: 'https://www.goodreads.com/book/show/25744928-deep-work' },
  { title: 'Mastery', author: 'Robert Greene', pillar: 'mastery', desc: 'The path to mastery through apprenticeship, practice, and creative insight.', url: 'https://www.goodreads.com/book/show/13589182-mastery' },
  { title: 'Peak', author: 'Anders Ericsson', pillar: 'mastery', desc: 'The new science of expertise \u2014 deliberate practice explained.', url: 'https://www.goodreads.com/book/show/26312997-peak' },
  { title: 'The Art of Learning', author: 'Josh Waitzkin', pillar: 'mastery', desc: 'A chess prodigy and martial artist shares his approach to mastering any skill.', url: 'https://www.goodreads.com/book/show/857333.The_Art_of_Learning' },
  { title: "So Good They Can't Ignore You", author: 'Cal Newport', pillar: 'mastery', desc: 'Why skills trump passion in the quest for work you love.', url: 'https://www.goodreads.com/book/show/13525945-so-good-they-can-t-ignore-you' },
  // Social
  { title: 'How to Win Friends and Influence People', author: 'Dale Carnegie', pillar: 'social', desc: 'The original guide to building genuine relationships and influence.', url: 'https://www.goodreads.com/book/show/4865.How_to_Win_Friends_and_Influence_People' },
  { title: 'Never Split the Difference', author: 'Chris Voss', pillar: 'social', desc: 'Negotiation tactics from a former FBI hostage negotiator.', url: 'https://www.goodreads.com/book/show/26156469-never-split-the-difference' },
  { title: 'The Charisma Myth', author: 'Olivia Fox Cabane', pillar: 'social', desc: 'Charisma is a learnable skill \u2014 here is the science behind it.', url: 'https://www.goodreads.com/book/show/11910905-the-charisma-myth' },
  { title: 'Influence', author: 'Robert Cialdini', pillar: 'social', desc: 'The psychology of persuasion \u2014 six principles that drive human behavior.', url: 'https://www.goodreads.com/book/show/28815.Influence' },
  // Wealth
  { title: 'The Psychology of Money', author: 'Morgan Housel', pillar: 'wealth', desc: 'Timeless lessons on wealth, greed, and happiness.', url: 'https://www.goodreads.com/book/show/41881472-the-psychology-of-money' },
  { title: 'Rich Dad Poor Dad', author: 'Robert Kiyosaki', pillar: 'wealth', desc: 'What the rich teach their kids about money that others do not.', url: 'https://www.goodreads.com/book/show/69571.Rich_Dad_Poor_Dad' },
  { title: 'The Millionaire Fastlane', author: 'MJ DeMarco', pillar: 'wealth', desc: 'Crack the code to wealth \u2014 escape the slow lane of saving for 40 years.', url: 'https://www.goodreads.com/book/show/8055455-the-millionaire-fastlane' },
  { title: 'The Almanack of Naval Ravikant', author: 'Eric Jorgenson', pillar: 'wealth', desc: 'A guide to wealth and happiness from Silicon Valley\u2019s philosopher.', url: 'https://www.goodreads.com/book/show/54898389-the-almanack-of-naval-ravikant' },
];
