...
const BOOKS = [
  // Mind
  { title: 'Meditations', author: 'Marcus Aurelius', pillar: 'mind', desc: 'Timeless stoic wisdom on self-mastery and resilience from a Roman emperor.' },
  { title: "Man's Search for Meaning", author: 'Viktor Frankl', pillar: 'mind', desc: 'How finding purpose sustains you through even the worst suffering.' },
  { title: 'Thinking, Fast and Slow', author: 'Daniel Kahneman', pillar: 'mind', desc: 'Understand the two systems that drive how you think and decide.' },
  { title: 'The Power of Now', author: 'Eckhart Tolle', pillar: 'mind', desc: 'A guide to spiritual enlightenment through present-moment awareness.' },
  { title: 'Atomic Habits', author: 'James Clear', pillar: 'mind', desc: 'Tiny changes, remarkable results \u2014 the definitive guide to building better habits.' },
  // Body
  { title: 'Starting Strength', author: 'Mark Rippetoe', pillar: 'body', desc: 'The bible of barbell training \u2014 learn the five fundamental lifts.' },
  { title: 'Why We Sleep', author: 'Matthew Walker', pillar: 'body', desc: 'The science of sleep and why it is the most important thing you can do for health.' },
  { title: 'The Body Keeps the Score', author: 'Bessel van der Kolk', pillar: 'body', desc: 'How trauma reshapes the body and brain, and how to heal.' },
  { title: 'Bigger Leaner Stronger', author: 'Michael Matthews', pillar: 'body', desc: 'Evidence-based approach to building muscle and losing fat.' },
  // Mastery
  { title: 'Deep Work', author: 'Cal Newport', pillar: 'mastery', desc: 'Rules for focused success in a distracted world.' },
  { title: 'Mastery', author: 'Robert Greene', pillar: 'mastery', desc: 'The path to mastery through apprenticeship, practice, and creative insight.' },
  { title: 'Peak', author: 'Anders Ericsson', pillar: 'mastery', desc: 'The new science of expertise \u2014 deliberate practice explained.' },
  { title: 'The Art of Learning', author: 'Josh Waitzkin', pillar: 'mastery', desc: 'A chess prodigy and martial artist shares his approach to mastering any skill.' },
  { title: "So Good They Can't Ignore You", author: 'Cal Newport', pillar: 'mastery', desc: 'Why skills trump passion in the quest for work you love.' },
  // Social
  { title: 'How to Win Friends and Influence People', author: 'Dale Carnegie', pillar: 'social', desc: 'The original guide to building genuine relationships and influence.' },
  { title: 'Never Split the Difference', author: 'Chris Voss', pillar: 'social', desc: 'Negotiation tactics from a former FBI hostage negotiator.' },
  { title: 'The Charisma Myth', author: 'Olivia Fox Cabane', pillar: 'social', desc: 'Charisma is a learnable skill \u2014 here is the science behind it.' },
  { title: 'Influence', author: 'Robert Cialdini', pillar: 'social', desc: 'The psychology of persuasion \u2014 six principles that drive human behavior.' },
  // Wealth
  { title: 'The Psychology of Money', author: 'Morgan Housel', pillar: 'wealth', desc: 'Timeless lessons on wealth, greed, and happiness.' },
  { title: 'Rich Dad Poor Dad', author: 'Robert Kiyosaki', pillar: 'wealth', desc: 'What the rich teach their kids about money that others do not.' },
  { title: 'The Millionaire Fastlane', author: 'MJ DeMarco', pillar: 'wealth', desc: 'Crack the code to wealth \u2014 escape the slow lane of saving for 40 years.' },
  { title: 'The Almanack of Naval Ravikant', author: 'Eric Jorgenson', pillar: 'wealth', desc: 'A guide to wealth and happiness from Silicon Valley\u2019s philosopher.' },
];
